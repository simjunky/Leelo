...
struct ModelData
    ...
    function ModelData(;interest_rate::Float64 = 0.0,
                        ...
                        pexistingG::Array{Float64, 2} = [0.0 0.0; 0.0 0.0],
                        costCapR::Array{Float64, 1} = [0.0],
                        costOperationVarR::Array{Float64, 1} = [0.0],
                        costOperationFixR::Array{Float64, 1} = [0.0],
                        ...
                        pexistingR::Array{Float64, 2} = [0.0 0.0; 0.0 0.0],
                        pRpho::Array{Float64, 2} = [0.0 0.0; 0.0 0.0],
                        costCapCT::Array{Float64, 1} = [0.0],
                        costOperationFixCT::Array{Float64, 1} = [0.0],
                        costOperationConvCT::Array{Float64, 1} = [0.0],
                        ...
                        costCapST::Array{Float64, 1} = [0.0],
                        costOperationVarST::Array{Float64, 1} = [0.0],
                        costOperationFixST::Array{Float64, 1} = [0.0],
                        ...
                        busH::Array{String, 1} = ["0.0"],
                        costCapUpgradeH::Array{Float64, 1} = [0.0],
                        pexistingH::Array{Float64, 1} = [0.0],
                        ...
                        busRoR::Array{String, 1} = ["0.0"],
                        maxCapacityPotL::Array{Float64, 1} = [0.0],
                        barO::Array{String, 1} = ["0.0"],
                        barD::Array{String, 1} = ["0.0"],
                        lossesL::Array{Float64, 1} = [0.0],
                        capLExisting::Array{Float64, 1} = [0.0],
                        ...
                        demand::Array{Float64, 2} = [0.0 0.0; 0.0 0.0],
                        ...
                        GHGOperationCT::Array{Float64, 1} = [0.0],
