...
struct ModelData
    ...
    function ModelData( interest_rate::Float64,
                        dt::Float64,
                        nt::Int64,
                        modelType::String,
                        scenario::String,
