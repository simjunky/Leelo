...
function add_model_variables(model::JuMP.Model, config::AbstrConfiguration, data::ModelData, i_current_year::Int64)
    ...
    # (t,b,g) power generated by conventional generator g during timestep t in bus b [MW]
    ...
    # total generated power (aux counter) [MW]
    ...
    # (t,h) flow to turbines of hydropower generator h during timestep t in [m^3/s]
